...
When I updated my portfolio's dependencies and (re)served it to Heroku on Aug 21st2020 - along with other semantic updates - it resulted in an application error. My goal is to use this repository to see if it is purely a Heroku x React issue. 
